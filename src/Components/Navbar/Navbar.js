    ...
    return (
        <div>
            ...
            <Navbar color="light" light expand="md">
                ...
                <NavbarBrand href="/home"><img src={mslogo} alt="MS logo"/></NavbarBrand>
                <NavbarToggler className="first-Button" onClick={toggle}>
                    <div className={cname}><span></span><span></span><span></span></div>            
                </NavbarToggler>
                </div>
            ...
            <div className="info">
                <p>Now use Microsoft Teams with family and friends to call, chat, and make plans. &nbsp;
